...
var aerospikeConnection aerospikeClient

func newAerospikeClient(dbUrl string, dbPort int, newConnection bool) AerospikeConnector {
	if newConnection {
	...
	if aerospikeConnection.cl == nil {
		cl, err := as.NewClient(dbUrl, dbPort)
		if err != nil {
			panic(err)
		}
		aerospikeConnection.cl = cl
	}
...
func (aerospike *aerospikeClient) Update(ctx context.Context, ns string, set string, key string, update interface{}) (interface{}, error) {
	...
	return nil, fmt.Errorf("Could not update aersospike")
}

func (aerospike *aerospikeClient) UpdateInsertQuery(ctx context.Context, QueryPolicy *as.QueryPolicy, WritePolicy *as.WritePolicy, statements *as.Statement, operations *as.Operation) (*as.ExecuteTask, error) {
	result, err := aerospike.cl.QueryExecute(QueryPolicy, WritePolicy, statements, operations)
	return result, err
}

func (aerospike *aerospikeClient) ReadQuery(ctx context.Context, QueryPolicy *as.QueryPolicy, statements *as.Statement) (*as.Recordset, error) {
